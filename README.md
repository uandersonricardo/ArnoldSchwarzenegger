...
```bash
uv run levd.py --watch --algorithm dqn --scenario full_deathmatch --resume-path 1_20251123_231836/policy_best.pth --render --test_levels 1

uv run levd.py --watch --algorithm dqn --scenario full_deathmatch --resume-path 1_20251123_231836/policy_best.pth --render --test_levels 0 --test_maps 2 4

uv run levd.py --watch --algorithm dqn --scenario full_deathmatch --resume-path 1_20251123_231836/policy_best.pth --render --test_levels 0 --test_maps 1 2 3 4 5
```
