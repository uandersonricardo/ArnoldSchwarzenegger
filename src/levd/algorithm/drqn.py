...
from src.levd.network import DRQN


class DRQNImpl(DQNImpl):
    ...
    def init_network(self) -> Module:
        return DRQN(self.args.state_shape, self.args.action_shape, hidden_size=self.args.hidden_size, device=self.args.device)
