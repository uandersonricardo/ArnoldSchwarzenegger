...
from src.riayn.replay_buffer import ReplayBuffer
...
class DQNAgent:
    ...
    def __init__(
        ...
        action_dim = env.action_space["binary"].n
    ...
    def select_action(self, state: np.ndarray) -> np.ndarray:
        ...
        if self.epsilon > np.random.random():
            selected_action = self.env.action_space["binary"].sample()
        else:
    ...
    def test(self) -> None:
        ...
        naive_env = self.env
        self.env = gym.wrappers.RecordVideo(self.env, video_folder="runs/")
